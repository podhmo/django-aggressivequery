...
class MyTest(TestCommand):
    ...
    # `python setup.py test -s  django_aggressivequery.tests.<module>.<class>.<method>`
    ...
    def run_tests(self):
        ...
        if "DJANGO_SETTINGS_MODULE" not in os.environ:
            os.environ["DJANGO_SETTINGS_MODULE"] = "django_aggressivequery.tests.settings"
...
setup(name='django-aggressivequery',
      ...
      author="podhmo",
      author_email="",
      url="https://github.com/podhmo/django-aggressivequery",
      packages=find_packages(exclude=["django_aggressivequery.tests"]),
      ...
      test_suite="django_aggressivequery.tests",
